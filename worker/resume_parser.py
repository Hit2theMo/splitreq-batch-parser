...
if __name__ == '__main__':
    ...
    path = r"/mnt/c/Users/Mohit Khanwale/Desktop/SplitReq/SplitReq-Parser/resumes/Resumes_latest/AaronHeckmann.doc"
    path = r"/mnt/c/Users/Mohit Khanwale/Desktop/SplitReq/SplitReq-Parser/resumes/Resumes_latest/Mukesh Budgujar.docx"
    # path = r"\mnt\c\Users\Mohit Khanwale\Desktop\SplitReq\SplitReq-Parser\resumes\sample_CVs\my_resume.pdf"
    #print("Converting Windows Path to Linux path on Linux OS---", PureWindowsPath(path).as_posix())

    path = str(path)
    print(path)
    data = extractDataPoints(path, 'docx')
